...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        <?= file_get_contents(base_url('admin/sidebar/index/add'))?>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="container">
            ...
            <!-- insert song start -->
            <form class="form-horizontal" action="<?=base_url('admin/schedule/add');?>" method="post" enctype="multipart/form-data">
              <div class="control-group">
                <label class="control-label" for="inputName">顯示日期</label>
                <div class="controls">
                  <input type="text" id="s_date" name="s_date" placeholder="Enter date...">格式:2014-01-01
                </div>
              </div>
              <div class="control-group">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="file" id="file" name="file">建議尺寸：148px * 175px
                </div>
              </div>
              <div class="control-group">
                <div class="controls">
